...
Build a platform to handle data that is time-based such as measurements from IoT devices, store them on a database and visualize it on a dashboard.
...
The platform is going to have 2 parts:app-name:

* Ingestion of the CSV files
* Ingestion of the API jason files



image::https://user-images.githubusercontent.com/63274055/155139250-784659fa-c228-4338-869d-54fd58aa3f3c.png[width=800]
