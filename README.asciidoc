...
:description: Build and deploy a Data Ingestion Pipeline (Pull)
...
To read the detailed step-by-step of my project, go to the Wiki section at the top of this page.
