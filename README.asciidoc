...
* On the EC2 terminal, I had to install the InfluxDB Python client library
...
* `*_live_weather_api_schedule.py_*`: Job Scheduler to run the script every hour.
...
https://youtu.be/_W1JlKVM8dY[Animation of the Data Pipeline (Video)]
